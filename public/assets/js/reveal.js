...
var ScrollReveal = function () {
    ...
    function m(e) {
        ...
        if (j.length) {
            A.property = S("transform"), A.computed = {
                raw: t[A.property], matrix: function (e) {
                    if ("string" == typeof e) {
        ...
        if (E.generated || A.generated.initial) {
            ...
            q.generated = {delayed: q.property + ": " + I.delayed + ";", instant: q.property + ": " + I.instant + ";"}
    ...
    function A(e, t) {
        var i = this;
        void 0 === e && (e = {type: "init"}), void 0 === t && (t = this.store.elements), O(function () {
