...
<nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
    ...
    <!-- Image Logo -->
    <a class="navbar-brand logo-image" href="index.blade.php"><img src="{{asset('assets/images/logo_RoboAds.png')}}" alt="alternative"></a>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="terms-conditions.blade.php"><span class="item-text">TERMS CONDITIONS</span></a>
                    <div class="dropdown-items-divide-hr"></div>
                    <a class="dropdown-item" href="privacy-policy.blade.php"><span class="item-text">PRIVACY POLICY</span></a>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link page-scroll" href="{{route('solutions')}}">SOLUTIONS</a>
            </li>
            <li class="nav-item">
                <a class="nav-link page-scroll" href="{{route('gallary')}}">GALLARY</a>
            </li>
            <li class="nav-item">
...
<header id="header" class="header">
    <div class="bg-video-wrap">
        <video src="{{asset('assets/video/FDH.mp4')}}" loop muted autoplay>
        </video>
        <div class="overlay">
            <div class="header-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="text-container">
                                <h1 id="coming_soon">FUTURE <span id="">OF ADVERTISING</span></h1>
                ...
                <p class="p-heading p-large" style="margin-top:62px " id="coming_soon">Let's multiply your reach with world's fastest Mobile Robot.</p>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="image-container" style="margin-top: 32px;">
                    <a target="_blank" href="https://www.youtube.com/watch?v=KBKFXYEJCB4"><img class="img-fluid" src="{{asset('assets/images/files/youtube_link.png')}}" alt="alternative"></a>
                </div> <!-- end of image-container -->
            </div> <!-- end of col -->
            <div class="col-lg-7">
                <div class="text-container">
                    <div class="section-title"></div>
                    <h2 style="color: black;-webkit-text-stroke: thin;letter-spacing: 2px;font-family: 'roboto';">ADVERTISE YOUR <br>
...
{{--   <div class="section-title">SERVICES</div>--}}{{--
                    ...
                    <h2>THIS WILL WORK LIKE <span id="coming_soon">THIS</span></h2>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="{{asset('assets/images/services-1.jpg')}}" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="{{asset('assets/images/services-2.jpg')}}" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="{{asset('assets/images/services-3.jpg')}}" alt="alternative">
                        </div>
                        <div class="card-body">
...
<div id="howitsworks">
    ...
    <div class="container">
        <h2 style="color: #051788" class="text-center">HOW THIS WILL WORK</h2>
        <h4 class="tex">Tradeshow, Summit, Event</h4>
            ...
            <div class="col-lg-6">
                ...
                <form id="callMeForm" data-toggle="validator" data-focus="false">
                    ...
                    <div class="form-group checkbox white">
                        <input type="checkbox" id="lterms" value="Agreed-to-Terms" name="lterms" required>I agree with Aria's stated <a class="white" href="privacy-policy.blade.php">Privacy Policy</a> and <a class="white" href="terms-conditions.blade.php">Terms & Conditions</a>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-lg-12">
                ...
                <div class="grid">
                    <div class="element-item development">
                        <a class="popup-with-move-anim" href="#project-1"><div class="element-item-overlay"><span>Online Banking</span></div><img src="{{asset('assets/images/project-1.jpg')}}" alt="alternative"></a>
                    </div>
                    <div class="element-item development">
                        <a class="popup-with-move-anim" href="#project-2"><div class="element-item-overlay"><span>Classic Industry</span></div><img src="{{asset('assets/images/project-2.jpg')}}" alt="alternative"></a>
                    </div>
                    <div class="element-item design development marketing">
                        <a class="popup-with-move-anim" href="#project-3"><div class="element-item-overlay"><span>BoomBap Audio</span></div><img src="{{asset('assets/images/project-3.jpg')}}" alt="alternative"></a>
                    </div>
                    <div class="element-item design development marketing">
                        <a class="popup-with-move-anim" href="#project-4"><div class="element-item-overlay"><span>Van Moose</span></div><img src="{{asset('assets/images/project-4.jpg')}}" alt="alternative"></a>
                    </div>
                    <div class="element-item design development marketing seo">
                        <a class="popup-with-move-anim" href="#project-5"><div class="element-item-overlay"><span>Joy Moments</span></div><img src="{{asset('assets/images/project-5.jpg')}}" alt="alternative"></a>
                    </div>
                    <div class="element-item design marketing seo">
                        <a class="popup-with-move-anim" href="#project-6"><div class="element-item-overlay"><span>Spark Events</span></div><img src="{{asset('assets/images/project-6.jpg')}}" alt="alternative"></a>
                    </div>
                    <div class="element-item design marketing">
                        <a class="popup-with-move-anim" href="#project-7"><div class="element-item-overlay"><span>Casual Wear</span></div><img src="{{asset('assets/images/project-7.jpg')}}" alt="alternative"></a>
                    </div>
                    <div class="element-item design marketing">
                        <a class="popup-with-move-anim" href="#project-8"><div class="element-item-overlay"><span>Zazoo Apps</span></div><img src="{{asset('assets/images/project-8.jpg')}}" alt="alternative"></a>
                    </div>
                </div> <!-- end of grid -->
                <!-- end of filter -->
            ...
            <div class="col-lg-6">
                ...
                <form id="contactForm" data-toggle="validator" data-focus="false">
                    ...
                    <div class="form-group checkbox">
                        <input type="checkbox" id="cterms" value="Agreed-to-Terms" required>I agree with Aria's stated <a href="privacy-policy.blade.php">Privacy Policy</a> and <a href="terms-conditions.blade.php">Terms Conditions</a>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-md-2">
                <div class="text-container">
                    ...
                    <ul class="list-unstyled li-space-lg white">
                        ...
                        <li>
                            <a class="white" href="terms-conditions.blade.php">Terms & Conditions</a>
                        </li>
                        <li>
                            <a class="white" href="privacy-policy.blade.php">Privacy Policy</a>
                        </li>
                    </ul>
                </div> <!-- end of text-container -->
            </div> <!-- end of col -->
...
<div class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <p class="p-small">Copyright © 2020 <a href="https://inovatik.com">ROBOADS</a></p>
            </div> <!-- end of col -->
        </div> <!-- enf of row -->
    </div> <!-- end of container -->
